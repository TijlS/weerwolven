...
document.querySelector(".voting").addEventListener("click", () => {
	isVoting = !isVoting;
	document.querySelector(".voting").textContent = isVoting
		? "Stemscherm verbergen"
		: "Stemscherm tonen";
...
document.querySelector(".werewolves").addEventListener("click", () => {
	...
	if (werewolvesActive == false) {
		...
		document.querySelector(".werewolves").textContent = "Weerwolven slapen"
	}
